...
import { ChevronRightIcon } from "@exawizards/exabase-design-system-icons-react"
...
import { NAV_ITEMS, FOOTER_ITEMS, type NavMainItem } from "./routes"
...
export function Sidebar({ collapsed, onToggleCollapse }: SidebarProps) {
  ...
  useEffect(() => {
    setExpanded((prev) => {
      ...
      for (const item of NAV_ITEMS) {
        if (!item.children) continue
        // Auto-expand only when on a sub-route; toggling the main item is
        // handled by the row's onClick so it can freely open and close.
